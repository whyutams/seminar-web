...
<body class="index-page">
    ...
    <main class="main">
            ...
            <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <a href="{{ url("index") }}" class="btn btn-primary p-2 mt-4">Registration Form</a>
                    </div>
                </div>
            </div>
        ...
        <section id="what-we-do" class="what-we-do section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam culpa itaque esse, voluptatum ipsum
                    laborum explicabo rem dolore corrupti sit, magnam laboriosam dolorem, corporis eos adipisci
                    reiciendis. Explicabo, ducimus exercitationem!</p>
                <button class="btn btn-primary p-2 mt-4">Lorem, ipsum.</button>
                        ...
                        <div class="d-flex " data-aos="fade-up" data-aos-delay="200">
                            <div class="col-md-4 mx-3">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    <img width="128" class="mb-4 rounded-circle shadow-4-strong" alt="avatar2"
                            ...
                            <div class="col-md-4 mx-3" data-aos="fade-up" data-aos-delay="300">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    <img width="128" class="mb-4 rounded-circle shadow-4-strong" alt="avatar2"
                                        src="https://mdbcdn.b-cdn.net/img/new/avatars/1.webp" />
                            ...
                            <div class="col-md-4 mx-3" data-aos="fade-up" data-aos-delay="400">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    <img width="128" class="mb-4 rounded-circle shadow-4-strong" alt="avatar2"
                                        src="https://mdbcdn.b-cdn.net/img/new/avatars/1.webp" />
            ...
            <div class="container">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset("templates/img/about.jpg") }}" alt="" class="img-fluid">
                    </div>
    ...
    <footer id="footer" class="footer light-background">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Lumia</strong> <span>All Rights Reserved</span>
            </p>
            <div class="credits">
